...
namespace MessagePack.Unity
{
    ...
    internal static class UnityResolveryResolverGetFormatterHelper
    {
        static readonly Dictionary<Type, object> formatterMap = new Dictionary<Type, object>()
        {
            ...
            // standard + array
            {typeof(Vector2[]),new UnsafeStaticArrayFormatter<Vector2>(Vector2Formatter.Instance)},
            {typeof(Vector3[]), new UnsafeStaticArrayFormatter<Vector3>(Vector3Formatter.Instance)},
