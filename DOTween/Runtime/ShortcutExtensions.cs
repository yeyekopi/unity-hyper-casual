...
namespace DG.Tweening
{
    ...
    public static class ShortcutExtensions
    {
        ...
        {
            TweenerCore<float, float, FloatOptions> t = DOTween.To<DOAspectCore>(() => target.aspect, x => target.aspect = x, endValue, duration);
            t.SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        {
            TweenerCore<Color, Color, ColorOptions> t = DOTween.To<DOColorCore>(() => target.backgroundColor, x => target.backgroundColor = x, endValue, duration);
            t.SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        /// Also stores the camera as the tween's target so it can be used for filtered operations</summary>
        /// <param name="endValue">The end value to reach</param><param name="duration">The duration of the tween</param>
        [Obsolete(DOTween.STREAMING_OBSOLETE_REASON)]
        ...
        {
            TweenerCore<float, float, FloatOptions> t = DOTween.To<DOOrthoSizeCore>(() => target.orthographicSize, x => target.orthographicSize = x, endValue, duration);
            t.SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        {
            TweenerCore<Rect, Rect, RectOptions> t = DOTween.To<DOPixelRectCore>(() => target.pixelRect, x => target.pixelRect = x, endValue, duration);
            t.SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        {
            TweenerCore<Rect, Rect, RectOptions> t = DOTween.To<DORectCore>(() => target.rect, x => target.rect = x, endValue, duration);
            t.SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        public static Tweener DOShakePosition(this Camera target, float duration, float strength = 3, int vibrato = 10, float randomness = 90, bool fadeOut = true)
        {
            ...
            return DOTween.Shake<DOShakePositionCore>(() => target.transform.localPosition, x => target.transform.localPosition = x, duration, strength, vibrato, randomness, true, fadeOut)
                .SetTarget(target).SetSpecialStartupMode(SpecialStartupMode.SetCameraShakePosition).SetStreamingData(new TweenStreamingData(target));
        }
        /// <summary>Shakes a Camera's localPosition along its relative X Y axes with the given values.
        /// Also stores the camera as the tween's target so it can be used for filtered operations</summary>
        /// <param name="duration">The duration of the tween</param>
        ...
        public static Tweener DOShakePosition(this Camera target, float duration, Vector3 strength, int vibrato = 10, float randomness = 90, bool fadeOut = true)
        {
            ...
            return DOTween.Shake<DOShakePositionCore>(() => target.transform.localPosition, x => target.transform.localPosition = x, duration, strength, vibrato, randomness, fadeOut)
                .SetTarget(target).SetSpecialStartupMode(SpecialStartupMode.SetCameraShakePosition).SetStreamingData(new TweenStreamingData(target));
        }
        ...
        public static Tweener DOShakeRotation(this Camera target, float duration, float strength = 90, int vibrato = 10, float randomness = 90, bool fadeOut = true)
        {
            ...
            return DOTween.Shake<DOShakeRotationCore>(() => target.transform.localEulerAngles, x => target.transform.localRotation = Quaternion.Euler(x), duration, strength, vibrato, randomness, false, fadeOut)
                .SetTarget(target).SetSpecialStartupMode(SpecialStartupMode.SetShake).SetStreamingData(new TweenStreamingData(target));
        }
        /// <summary>Shakes a Camera's localRotation.
        /// Also stores the camera as the tween's target so it can be used for filtered operations</summary>
        /// <param name="duration">The duration of the tween</param>
        ...
        public static Tweener DOShakeRotation(this Camera target, float duration, Vector3 strength, int vibrato = 10, float randomness = 90, bool fadeOut = true)
        {
            ...
            return DOTween.Shake<DOShakeRotationCore>(() => target.transform.localEulerAngles, x => target.transform.localRotation = Quaternion.Euler(x), duration, strength, vibrato, randomness, fadeOut)
                .SetTarget(target).SetSpecialStartupMode(SpecialStartupMode.SetShake).SetStreamingData(new TweenStreamingData(target));
        }
        ...
        {
            TweenerCore<Color, Color, ColorOptions> t = DOTween.To<DOColorCore>(() => target.color, x => target.color = x, endValue, duration);
            t.SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        {
            TweenerCore<float, float, FloatOptions> t = DOTween.To<DOIntensityCore>(() => target.intensity, x => target.intensity = x, endValue, duration);
            t.SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        public static TweenerCore<Color, Color, ColorOptions> DOColor(this Material target, Color endValue, string property, float duration)
        {
            ...
            TweenerCore<Color, Color, ColorOptions> t = DOTween.To<DOColorCore>(() => target.GetColor(property), x => target.SetColor(property, x), endValue, duration);
            t.SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        public static TweenerCore<Color, Color, ColorOptions> DOColor(this Material target, Color endValue, int propertyID, float duration)
        {
            ...
            TweenerCore<Color, Color, ColorOptions> t = DOTween.To<DOColorCore>(() => target.GetColor(propertyID), x => target.SetColor(propertyID, x), endValue, duration);
            t.SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        {
            TweenerCore<Color, Color, ColorOptions> t = DOTween.ToAlpha<DOFadeCore>(() => target.color, x => target.color = x, endValue, duration);
            t.SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        public static TweenerCore<Color, Color, ColorOptions> DOFade(this Material target, float endValue, string property, float duration)
        {
            ...
            TweenerCore<Color, Color, ColorOptions> t = DOTween.ToAlpha<DOFadeCore>(() => target.GetColor(property), x => target.SetColor(property, x), endValue, duration);
            t.SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        public static TweenerCore<Color, Color, ColorOptions> DOFade(this Material target, float endValue, int propertyID, float duration)
        {
            ...
            TweenerCore<Color, Color, ColorOptions> t = DOTween.ToAlpha<DOFadeCore>(() => target.GetColor(propertyID), x => target.SetColor(propertyID, x), endValue, duration);
            t.SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        public static TweenerCore<float, float, FloatOptions> DOFloat(this Material target, float endValue, string property, float duration)
        {
            ...
            DOFloatCore t = DOTween.To<DOFloatCore>(() => target.GetFloat(property), x => target.SetFloat(property, x), endValue, duration);
            t.property = property;
            t.SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        ...
        public static TweenerCore<float, float, FloatOptions> DOFloat(this Material target, float endValue, int propertyID, float duration)
        {
            ...
            TweenerCore<float, float, FloatOptions> t = DOTween.To<DOFloatCore>(() => target.GetFloat(propertyID), x => target.SetFloat(propertyID, x), endValue, duration);
            t.SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        public static Tweener DOResize(this TrailRenderer target, float toStartWidth, float toEndWidth, float duration)
        {
            return DOTween.To(() => new Vector2(target.startWidth, target.endWidth), x => {
                ...
                .SetTarget(target).SetStreamingData(new TweenStreamingData(target));
        }
        ...
        {
            TweenerCore<float, float, FloatOptions> t = DOTween.To<DOTimeCore>(() => target.time, x => target.time = x, endValue, duration);
            t.SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        {
            var t = DOTween.To<DOMoveCore>(() => target.position, x => target.position = x, endValue, duration);
            t.SetStreamingData(new TweenStreamingData(target));
        ...
        {
            var t = DOTween.To<DOMoveCore>(() => target.position, x => target.position = x, new Vector3(endValue, 0, 0), duration);
            t.SetStreamingData(new TweenStreamingData(target));
        ...
        {
            TweenerCore<Vector3, Vector3, VectorOptions> t = DOTween.To<DOMoveCore>(() => target.position, x => target.position = x, new Vector3(0, endValue, 0), duration);
        ...
        {
            TweenerCore<Vector3, Vector3, VectorOptions> t = DOTween.To<DOMoveCore>(() => target.position, x => target.position = x, new Vector3(0, 0, endValue), duration);
        ...
        {
            TweenerCore<Vector3, Vector3, VectorOptions> t = DOTween.To<DOLocalMoveCore>(() => target.localPosition, x => target.localPosition = x, endValue, duration);
        ...
        {
            TweenerCore<Vector3, Vector3, VectorOptions> t = DOTween.To<DOLocalMoveCore>(() => target.localPosition, x => target.localPosition = x, new Vector3(endValue, 0, 0), duration);
            t.SetOptions(AxisConstraint.X, snapping).SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        {
            TweenerCore<Vector3, Vector3, VectorOptions> t = DOTween.To<DOLocalMoveCore>(() => target.localPosition, x => target.localPosition = x, new Vector3(0, endValue, 0), duration);
            t.SetOptions(AxisConstraint.Y, snapping).SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        {
            TweenerCore<Vector3, Vector3, VectorOptions> t = DOTween.To<DOLocalMoveCore>(() => target.localPosition, x => target.localPosition = x, new Vector3(0, 0, endValue), duration);
            t.SetOptions(AxisConstraint.Z, snapping).SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        {
            TweenerCore<DOQuaternion, DOVector3, QuaternionOptions> t = DOTween.To<DORotateCore>(() => target.rotation, x => target.rotation = x, endValue, duration);
            t.SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
        ...
        {
            TweenerCore<DOQuaternion, DOQuaternion, NoOptions> t = DOTween.To<DORotateQuaternionCore, DOQuaternion, DOQuaternion, NoOptions>(PureQuaternionPlugin.Plug(), () => target.rotation, x => target.rotation = x, endValue, duration);
            t.SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        {
            TweenerCore<DOQuaternion, DOVector3, QuaternionOptions> t = DOTween.To<DOLocalRotateCore>(() => target.localRotation, x => target.localRotation = x, endValue, duration);
            t.SetTarget(target);
            t.plugOptions.rotateMode = mode;
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        ...
        {
            TweenerCore<Quaternion, Quaternion, NoOptions> t = DOTween.To<DOLocalRotateQuaternionCore, Quaternion, Quaternion, NoOptions>(PureQuaternionPlugin.Plug(), () => target.localRotation, x => target.localRotation = x, endValue, duration);
            t.SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        {
            TweenerCore<Vector3, Vector3, VectorOptions> t = DOTween.To<DOScaleCore>(() => target.localScale, x => target.localScale = x, endValue, duration);
            t.SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        public static TweenerCore<Vector3, Vector3, VectorOptions> DOScale(this Transform target, float endValue, float duration)
        {
            ...
            TweenerCore<Vector3, Vector3, VectorOptions> t = DOTween.To<DOScaleCore>(() => target.localScale, x => target.localScale = x, endValueV3, duration);
            t.SetTarget(target);
            t.SetStreamingData(new TweenStreamingData(target));
            return t;
        }
        ...
        {
            TweenerCore<Vector3, Vector3, VectorOptions> t =  DOTween.To<DOScaleCore>(() => target.localScale, x => target.localScale = x, new Vector3(endValue, 0, 0), duration);
        ...
        {
            TweenerCore<Vector3, Vector3, VectorOptions> t = DOTween.To<DOScaleCore>(() => target.localScale, x => target.localScale = x, new Vector3(0, endValue, 0), duration);
        ...
        {
            TweenerCore<Vector3, Vector3, VectorOptions> t = DOTween.To<DOScaleCore>(() => target.localScale, x => target.localScale = x, new Vector3(0, 0, endValue), duration);
        ...
        public static Tweener DOLookAt(this Transform target, Vector3 towards, float duration, AxisConstraint axisConstraint = AxisConstraint.None, Vector3? up = null)
        {
            ...
            TweenerCore<DOQuaternion, DOVector3, QuaternionOptions> t = DOTween.To<DOLookAtCore>(() => target.rotation, x => target.rotation = x, towards, duration)
                .SetTarget(target).SetSpecialStartupMode(SpecialStartupMode.SetLookAt);
            t.plugOptions.axisConstraint = axisConstraint;
            t.plugOptions.up = (up == null) ? Vector3.up : up.Value;
        ...
        public static Tweener DOPunchPosition(this Transform target, Vector3 punch, float duration, int vibrato = 10, float elasticity = 1, bool snapping = false)
        {
            ...
            var t = DOTween.Punch<DOPunchPositionCore>(() => target.localPosition, x => target.localPosition = x, punch, duration, vibrato, elasticity);
            t.SetStreamingData(new TweenStreamingData(target)).SetTarget(target).SetOptions(snapping);
        ...
        public static Tweener DOPunchScale(this Transform target, Vector3 punch, float duration, int vibrato = 10, float elasticity = 1)
        {
            ...
            var t = DOTween.Punch<DOPunchScaleCore>(() => target.localScale, x => target.localScale = x, punch, duration, vibrato, elasticity);
            t.SetStreamingData(new TweenStreamingData(target)).SetTarget(target);
        ...
        public static Tweener DOPunchRotation(this Transform target, Vector3 punch, float duration, int vibrato = 10, float elasticity = 1)
        {
            ...
            var t = DOTween.Punch<DOPunchRotationCore>(() => target.localEulerAngles, x => target.localRotation = Quaternion.Euler(x), punch, duration, vibrato, elasticity);
                t.SetStreamingData(new TweenStreamingData(target)).SetTarget(target);
            return t;
        }
        ...
        public static Tweener DOShakePosition(this Transform target, float duration, float strength = 1, int vibrato = 10, float randomness = 90, bool snapping = false, bool fadeOut = true)
        {
            ...
            var t = DOTween.Shake<DOShakePositionCore>(() => target.localPosition, x => target.localPosition = x, duration, strength, vibrato, randomness, false, fadeOut);
            t.SetStreamingData(new TweenStreamingData(target)).SetTarget(target).SetSpecialStartupMode(SpecialStartupMode.SetShake).SetOptions(snapping);
        ...
        public static Tweener DOShakePosition(this Transform target, float duration, Vector3 strength, int vibrato = 10, float randomness = 90, bool snapping = false, bool fadeOut = true)
        {
            ...
            var t = DOTween.Shake<DOShakePositionCore>(() => target.localPosition, x => target.localPosition = x, duration, strength, vibrato, randomness, fadeOut);
            t.SetStreamingData(new TweenStreamingData(target)).SetTarget(target).SetSpecialStartupMode(SpecialStartupMode.SetShake).SetOptions(snapping);
        ...
        public static Tweener DOShakeRotation(this Transform target, float duration, float strength = 90, int vibrato = 10, float randomness = 90, bool fadeOut = true)
        {
            ...
            var t = DOTween.Shake<DOShakeRotationCore>(() => target.localEulerAngles, x => target.localRotation = Quaternion.Euler(x), duration, strength, vibrato, randomness, false, fadeOut);
            t.SetStreamingData(new TweenStreamingData(target)).SetTarget(target).SetSpecialStartupMode(SpecialStartupMode.SetShake);
        ...
        public static Tweener DOShakeRotation(this Transform target, float duration, Vector3 strength, int vibrato = 10, float randomness = 90, bool fadeOut = true)
        {
            ...
            var t = DOTween.Shake<DOShakeRotationCore>(() => target.localEulerAngles, x => target.localRotation = Quaternion.Euler(x), duration, strength, vibrato, randomness, fadeOut);
            t.SetStreamingData(new TweenStreamingData(target)).SetTarget(target).SetSpecialStartupMode(SpecialStartupMode.SetShake);
        ...
        public static Tweener DOShakeScale(this Transform target, float duration, float strength = 1, int vibrato = 10, float randomness = 90, bool fadeOut = true)
        {
            ...
            var t = DOTween.Shake<DOShakeScaleCore>(() => target.localScale, x => target.localScale = x, duration, strength, vibrato, randomness, false, fadeOut);
            t.SetStreamingData(new TweenStreamingData(target)).SetTarget(target).SetSpecialStartupMode(SpecialStartupMode.SetShake);
            return t;
        }
        /// <summary>Shakes a Transform's localScale.</summary>
        ...
        public static Tweener DOShakeScale(this Transform target, float duration, Vector3 strength, int vibrato = 10, float randomness = 90, bool fadeOut = true)
        {
            ...
            var t = DOTween.Shake<DOShakeScaleCore>(() => target.localScale, x => target.localScale = x, duration, strength, vibrato, randomness, fadeOut);
                t.SetStreamingData(new TweenStreamingData(target)).SetTarget(target).SetSpecialStartupMode(SpecialStartupMode.SetShake);
        ...
        public static Sequence DOJump(this Transform target, Vector3 endValue, float jumpPower, int numJumps, float duration, bool snapping = false)
        {
            ...
            Tween yTween = DOTween.To(() => target.position, x => target.position = x, new Vector3(0, jumpPower, 0), duration / (numJumps * 2))
                .SetStreamingData(new TweenStreamingData(target))
...
//            return s;
        ...
        public static Sequence DOLocalJump(this Transform target, Vector3 endValue, float jumpPower, int numJumps, float duration, bool snapping = false)
        {
            ...
            Sequence s = DOTween.Sequence();
            s.Append(
                DOTween.To(() => target.localPosition, x => target.localPosition = x, new Vector3(endValue.x, 0, 0), duration)
                .SetStreamingData(new TweenStreamingData(target))
                .SetOptions(AxisConstraint.X, snapping)
                .SetEase(Ease.Linear)
            )
            .Join(
                DOTween.To(() => target.localPosition, x => target.localPosition = x, new Vector3(0, 0, endValue.z), duration)
                .SetStreamingData(new TweenStreamingData(target))
                .SetOptions(AxisConstraint.Z, snapping)
                .SetEase(Ease.Linear)
            )
            .Join(
                DOTween.To(() => target.localPosition, x => target.localPosition = x, new Vector3(0, jumpPower, 0), duration / (numJumps * 2))
                .SetStreamingData(new TweenStreamingData(target))
        ...
        )
        {
            ...
            TweenerCore<Vector3, Path, PathOptions> t = DOTween.To<Vector3, Path, PathOptions>(PathPlugin.Get(), () => target.position, x => target.position = x, new Path(pathType, path, resolution, gizmoColor), duration)
            .SetStreamingData(new TweenStreamingData(target))
                .SetTarget(target);
        ...
        {
            if (resolution < 1) resolution = 1;
            TweenerCore<Vector3, Path, PathOptions> t = DOTween.To<Vector3, Path, PathOptions>(PathPlugin.Get(), () => target.localPosition, x => target.localPosition = x, new Path(pathType, path, resolution, gizmoColor), duration)
                .SetStreamingData(new TweenStreamingData(target)).SetTarget(target);
        ...
        {
            TweenerCore<Vector3, Path, PathOptions> t = DOTween.To<Vector3, Path, PathOptions>(PathPlugin.Get(), () => target.position, x => target.position = x, path, duration)
                .SetStreamingData(new TweenStreamingData(target)).SetTarget(target);
        ...
        {
            TweenerCore<Vector3, Path, PathOptions> t = DOTween.To<Vector3, Path, PathOptions>(PathPlugin.Get(), () => target.localPosition, x => target.localPosition = x, path, duration)
                .SetStreamingData(new TweenStreamingData(target)).SetTarget(target);
        ...
        public static Tweener DOBlendableColor(this Light target, Color endValue, float duration)
        {
            ...
            return DOTween.To(() => to, x => {
                ...
                .Blendable().SetTarget(target).SetStreamingData(new TweenStreamingData(target));
        }
        ...
        public static Tweener DOBlendableMoveBy(this Transform target, Vector3 byValue, float duration, bool snapping = false)
        {
            ...
            return DOTween.To(() => to, x => {
                ...
                .Blendable().SetStreamingData(new TweenStreamingData(target)).SetOptions(snapping).SetTarget(target);
        }
        ...
        {
            Vector3 to = Vector3.zero;
            return DOTween.To<DOBlendableLocalMoveByCore>(() => to, x => {
#if COMPATIBLE
                Vector3 diff = x.value - to;
#else
                Vector3 diff = x - to;
...
//            Quaternion to = target.rotation;
            ...
            TweenerCore<DOQuaternion, DOVector3, QuaternionOptions> t = DOTween.To<DOBlendableRotateByCore>(() => to, x => {
#if COMPATIBLE
                ...
                .Blendable().SetStreamingData(new TweenStreamingData(target)).SetTarget(target);
            t.plugOptions.rotateMode = mode;
            return t;
        }
...
//            Quaternion to = target.localRotation;
            Quaternion to = Quaternion.identity;
            TweenerCore<DOQuaternion, DOVector3, QuaternionOptions> t = DOTween.To<DOBlendableLocalRotateByCore>(() => to, x => {
#if COMPATIBLE
                Quaternion diff = x.value * Quaternion.Inverse(to);
#else
                Quaternion diff = x * Quaternion.Inverse(to);
        ...
        {
            Vector3 to = Vector3.zero;
            return DOTween.To<DOScaleCore>(() => to, x => {
#if COMPATIBLE
                Vector3 diff = x.value - to;
#else
                Vector3 diff = x - to;
