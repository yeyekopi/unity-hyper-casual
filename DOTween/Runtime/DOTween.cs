...
namespace DG.Tweening
{
    ...
    public class DOTween
    {
        ...
        public const string STREAMING_OBSOLETE_REASON = "Not compatible with streaming.";
        ...
        [ThreadStatic]
        static bool isUnityThread;
        internal static void AssertUnityThread() {
            if(!isUnityThread) {
                throw new InvalidOperationException("Can only access DOTween API on the main thread");
            }
        }
        public static void MarkUnityThread() {
            isUnityThread = true;
        }
        ...
        public static IDOTweenInit Init(bool? recycleAllByDefault = null, bool? useSafeMode = null, LogBehaviour? logBehaviour = null)
        {
            ...
            return _init(recycleAllByDefault, useSafeMode, logBehaviour);
        }
        // Auto-init
        ...
        // Full init
        static IDOTweenInit _init(bool? recycleAllByDefault, bool? useSafeMode, LogBehaviour? logBehaviour)
        {
            initialized = true;
            // Options
        ...
        public static void ManualUpdate(float deltaTime, int streamFilter = -1)
        {
            InitCheck();
//            instance.ManualUpdate(deltaTime, unscaledDeltaTime);
            if (TweenManager.hasActiveManualTweens) {
                TweenManager.Update(UpdateType.Manual, deltaTime, streamFilter);
            }
        }
        ...
        /// <para>Example usage with lambda:</para><code>x=> myProperty = x</code></param>
        /// <param name="endValue">The end value to reach</param><param name="duration">The tween's duration</param>
        public static TCore To<TCore>(DOGetter<float> getter, DOSetter<float> setter, float endValue, float duration) where TCore : TweenerCore<float, float, FloatOptions>, new()
        { return ApplyTo<TCore, float, float, FloatOptions>(getter, setter, endValue, duration); }
        /// <summary>Tweens a property or field to the given value using default plugins</summary>
        /// <param name="getter">A getter for the field or property to tween.
        /// <para>Example usage with lambda:</para><code>()=> myProperty</code></param>
        /// <param name="setter">A setter for the field or property to tween
        /// <para>Example usage with lambda:</para><code>x=> myProperty = x</code></param>
        /// <param name="endValue">The end value to reach</param><param name="duration">The tween's duration</param>
        public static TCore To<TCore>(DOGetter<double> getter, DOSetter<double> setter, double endValue, float duration) where TCore : TweenerCore<double, double, NoOptions>, new()
        { return ApplyTo<TCore, double, double, NoOptions>(getter, setter, endValue, duration); }
        /// <summary>Tweens a property or field to the given value using default plugins</summary>
        /// <param name="getter">A getter for the field or property to tween.
        /// <para>Example usage with lambda:</para><code>()=> myProperty</code></param>
        /// <param name="setter">A setter for the field or property to tween
        /// <para>Example usage with lambda:</para><code>x=> myProperty = x</code></param>
        /// <param name="endValue">The end value to reach</param><param name="duration">The tween's duration</param>
        public static TCore To<TCore>(DOGetter<int> getter, DOSetter<int> setter, int endValue, float duration) where TCore : TweenerCore<int, int, NoOptions>, new()
        { return ApplyTo<TCore, int, int, NoOptions>(getter, setter, endValue, duration); }
        /// <summary>Tweens a property or field to the given value using default plugins</summary>
        /// <param name="getter">A getter for the field or property to tween.
        /// <para>Example usage with lambda:</para><code>()=> myProperty</code></param>
        /// <param name="setter">A setter for the field or property to tween
        /// <para>Example usage with lambda:</para><code>x=> myProperty = x</code></param>
        /// <param name="endValue">The end value to reach</param><param name="duration">The tween's duration</param>
        public static TCore To<TCore>(DOGetter<uint> getter, DOSetter<uint> setter, uint endValue, float duration) where TCore : TweenerCore<uint, uint, UintOptions>, new()
        { return ApplyTo<TCore, uint, uint, UintOptions>(getter, setter, endValue, duration); }
        /// <summary>Tweens a property or field to the given value using default plugins</summary>
        /// <param name="getter">A getter for the field or property to tween.
        /// <para>Example usage with lambda:</para><code>()=> myProperty</code></param>
        /// <param name="setter">A setter for the field or property to tween
        /// <para>Example usage with lambda:</para><code>x=> myProperty = x</code></param>
        /// <param name="endValue">The end value to reach</param><param name="duration">The tween's duration</param>
        public static TCore To<TCore>(DOGetter<long> getter, DOSetter<long> setter, long endValue, float duration) where TCore : TweenerCore<long, long, NoOptions>, new()
        { return ApplyTo<TCore, long, long, NoOptions>(getter, setter, endValue, duration); }
        /// <summary>Tweens a property or field to the given value using default plugins</summary>
        /// <param name="getter">A getter for the field or property to tween.
        /// <para>Example usage with lambda:</para><code>()=> myProperty</code></param>
        /// <param name="setter">A setter for the field or property to tween
        /// <para>Example usage with lambda:</para><code>x=> myProperty = x</code></param>
        /// <param name="endValue">The end value to reach</param><param name="duration">The tween's duration</param>
        public static TCore To<TCore>(DOGetter<ulong> getter, DOSetter<ulong> setter, ulong endValue, float duration) where TCore : TweenerCore<ulong, ulong, NoOptions>, new()
        { return ApplyTo<TCore, ulong, ulong, NoOptions>(getter, setter, endValue, duration); }
        /// <summary>Tweens a property or field to the given value using default plugins</summary>
        /// <param name="getter">A getter for the field or property to tween.
        /// <para>Example usage with lambda:</para><code>()=> myProperty</code></param>
        /// <param name="setter">A setter for the field or property to tween
        /// <para>Example usage with lambda:</para><code>x=> myProperty = x</code></param>
        /// <param name="endValue">The end value to reach</param><param name="duration">The tween's duration</param>
        public static TCore To<TCore>(DOGetter<string> getter, DOSetter<string> setter, string endValue, float duration) where TCore : TweenerCore<string, string, StringOptions>, new()
        { return ApplyTo<TCore, string, string, StringOptions>(getter, setter, endValue, duration); }
        /// <summary>Tweens a property or field to the given value using default plugins</summary>
        /// <param name="getter">A getter for the field or property to tween.
        /// <para>Example usage with lambda:</para><code>()=> myProperty</code></param>
        /// <param name="setter">A setter for the field or property to tween
        /// <para>Example usage with lambda:</para><code>x=> myProperty = x</code></param>
        /// <param name="endValue">The end value to reach</param><param name="duration">The tween's duration</param>
        public static TCore To<TCore>(DOGetter<DOVector2> getter, DOSetter<DOVector2> setter, Vector2 endValue, float duration) where TCore : TweenerCore<DOVector2, DOVector2, VectorOptions>, new()
        { return ApplyTo<TCore, DOVector2, DOVector2, VectorOptions>(getter, setter, endValue, duration); }
        /// <summary>Tweens a property or field to the given value using default plugins</summary>
        /// <param name="getter">A getter for the field or property to tween.
        /// <para>Example usage with lambda:</para><code>()=> myProperty</code></param>
        /// <param name="setter">A setter for the field or property to tween
        /// <para>Example usage with lambda:</para><code>x=> myProperty = x</code></param>
        /// <param name="endValue">The end value to reach</param><param name="duration">The tween's duration</param>
        public static TCore To<TCore>(DOGetter<DOVector3> getter, DOSetter<DOVector3> setter, Vector3 endValue, float duration) where TCore : TweenerCore<DOVector3, DOVector3, VectorOptions>, new()
        { return ApplyTo<TCore, DOVector3, DOVector3, VectorOptions>(getter, setter, endValue, duration); }
        /// <summary>Tweens a property or field to the given value using default plugins</summary>
        /// <param name="getter">A getter for the field or property to tween.
        /// <para>Example usage with lambda:</para><code>()=> myProperty</code></param>
        /// <param name="setter">A setter for the field or property to tween
        /// <para>Example usage with lambda:</para><code>x=> myProperty = x</code></param>
        /// <param name="endValue">The end value to reach</param><param name="duration">The tween's duration</param>
        public static TCore To<TCore>(DOGetter<DOVector4> getter, DOSetter<DOVector4> setter, Vector4 endValue, float duration) where TCore : TweenerCore<DOVector4, DOVector4, VectorOptions>, new()
        { return ApplyTo<TCore, DOVector4, DOVector4, VectorOptions>(getter, setter, endValue, duration); }
        /// <summary>Tweens a property or field to the given value using default plugins</summary>
        /// <param name="getter">A getter for the field or property to tween.
        /// <para>Example usage with lambda:</para><code>()=> myProperty</code></param>
        /// <param name="setter">A setter for the field or property to tween
        /// <para>Example usage with lambda:</para><code>x=> myProperty = x</code></param>
        /// <param name="endValue">The end value to reach</param><param name="duration">The tween's duration</param>
        public static TCore To<TCore>(DOGetter<DOQuaternion> getter, DOSetter<DOQuaternion> setter, Vector3 endValue, float duration) where TCore : TweenerCore<DOQuaternion, DOVector3, QuaternionOptions>, new()
        { return ApplyTo<TCore, DOQuaternion, DOVector3, QuaternionOptions>(getter, setter, endValue, duration); }
        /// <summary>Tweens a property or field to the given value using default plugins</summary>
        /// <param name="getter">A getter for the field or property to tween.
        /// <para>Example usage with lambda:</para><code>()=> myProperty</code></param>
        /// <param name="setter">A setter for the field or property to tween
        /// <para>Example usage with lambda:</para><code>x=> myProperty = x</code></param>
        /// <param name="endValue">The end value to reach</param><param name="duration">The tween's duration</param>
        public static TCore To<TCore>(DOGetter<DOColor> getter, DOSetter<DOColor> setter, Color endValue, float duration) where TCore : TweenerCore<DOColor, DOColor, ColorOptions>, new()
        { return ApplyTo<TCore, DOColor, DOColor, ColorOptions>(getter, setter, endValue, duration); }
        /// <summary>Tweens a property or field to the given value using default plugins</summary>
        /// <param name="getter">A getter for the field or property to tween.
        /// <para>Example usage with lambda:</para><code>()=> myProperty</code></param>
        /// <param name="setter">A setter for the field or property to tween
        /// <para>Example usage with lambda:</para><code>x=> myProperty = x</code></param>
        /// <param name="endValue">The end value to reach</param><param name="duration">The tween's duration</param>
        public static TCore To<TCore>(DOGetter<Rect> getter, DOSetter<Rect> setter, Rect endValue, float duration) where TCore : TweenerCore<Rect, Rect, RectOptions>, new()
        { return ApplyTo<TCore, Rect, Rect, RectOptions>(getter, setter, endValue, duration); }
        /// <summary>Tweens a property or field to the given value using default plugins</summary>
        /// <param name="getter">A getter for the field or property to tween.
        /// <para>Example usage with lambda:</para><code>()=> myProperty</code></param>
        /// <param name="setter">A setter for the field or property to tween
        /// <para>Example usage with lambda:</para><code>x=> myProperty = x</code></param>
        /// <param name="endValue">The end value to reach</param><param name="duration">The tween's duration</param>
        public static TCore To<TCore>(DOGetter<RectOffset> getter, DOSetter<RectOffset> setter, RectOffset endValue, float duration) where TCore : TweenerCore<RectOffset, RectOffset, NoOptions>, new()
        { return ApplyTo<TCore, RectOffset, RectOffset, NoOptions>(getter, setter, endValue, duration); }
        ...
        /// <para>Example usage with lambda:</para><code>x=> myProperty = x</code></param>
        /// <param name="endValue">The end value to reach</param><param name="duration">The tween's duration</param>
        public static TCore To<TCore, T1, T2, TPlugOptions>(
            ABSTweenPlugin<T1, T2, TPlugOptions> plugin, DOGetter<T1> getter, DOSetter<T1> setter, T2 endValue, float duration
        )
            where TPlugOptions : struct, IPlugOptions where TCore : TweenerCore<T1, T2, TPlugOptions>, new()
        { return ApplyTo<TCore, T1, T2, TPlugOptions>(getter, setter, endValue, duration, plugin); }
        ...
        /// <param name="endValue">The end value to reach</param><param name="duration">The tween's duration</param>
        /// <param name="axisConstraint">The axis to tween</param>
        public static TCore ToAxis<TCore>(DOGetter<DOVector3> getter, DOSetter<DOVector3> setter, float endValue, float duration, AxisConstraint axisConstraint = AxisConstraint.X) where TCore : TweenerCore<DOVector3, DOVector3, VectorOptions>, new()
        {
            TCore t = ApplyTo<TCore, DOVector3, DOVector3, VectorOptions>(getter, setter, new Vector3(endValue, endValue, endValue), duration);
            t.plugOptions.axisConstraint = axisConstraint;
            return t;
        }
        ...
        /// <para>Example usage with lambda:</para><code>x=> myProperty = x</code></param>
        /// <param name="endValue">The end value to reach</param><param name="duration">The tween's duration</param>
        public static TCore ToAlpha<TCore>(DOGetter<DOColor> getter, DOSetter<DOColor> setter, float endValue, float duration) where TCore : TweenerCore<Color, Color, ColorOptions>, new()
        {
            TCore t = ApplyTo<TCore, DOColor, DOColor, ColorOptions>(getter, setter, new Color(0, 0, 0, endValue), duration);
            t.SetOptions(true);
            return t;
        }
        ...
        {
            return Punch<TweenerCore<Vector3, Vector3[], Vector3ArrayOptions>>(getter, setter, direction, duration, vibrato, elasticity);
        }
        ...
        /// 1 creates a full oscillation between the direction and the opposite decaying direction,
        /// while 0 oscillates only between the starting position and the decaying direction</param>
        public static TCore Punch<TCore>(DOGetter<Vector3> getter, DOSetter<Vector3> setter, Vector3 direction, float duration, int vibrato = 10, float elasticity = 1) where TCore : TweenerCore<Vector3, Vector3[], Vector3ArrayOptions>, new()
        {
            ...
            return ToArray<TCore>(getter, setter, tos, tDurations)
                .NoFrom<TCore, Vector3, Vector3[], Vector3ArrayOptions>()
        ...
        {
            return Shake<TweenerCore<Vector3, Vector3[], Vector3ArrayOptions>>(getter, setter, duration, new Vector3(strength, strength, strength), vibrato, randomness, ignoreZAxis, false, fadeOut);
        }
        /// <summary>Shakes a Vector3 with the given values.</summary>
        /// <param name="getter">A getter for the field or property to tween.
        /// <para>Example usage with lambda:</para><code>()=> myProperty</code></param>
        ...
        {
            return Shake<TweenerCore<Vector3, Vector3[], Vector3ArrayOptions>>(getter, setter, duration, strength, vibrato, randomness, false, true, fadeOut);
        }
        ...
        /// <param name="ignoreZAxis">If TRUE only shakes on the X Y axis (looks better with things like cameras).</param>
        /// <param name="fadeOut">If TRUE the shake will automatically fadeOut smoothly within the tween's duration, otherwise it will not</param>
        public static TCore Shake<TCore>(DOGetter<Vector3> getter, DOSetter<Vector3> setter, float duration,
            float strength = 3, int vibrato = 10, float randomness = 90, bool ignoreZAxis = true, bool fadeOut = true
        ) where TCore : TweenerCore<Vector3, Vector3[], Vector3ArrayOptions>, new()
        {
            return Shake<TCore>(getter, setter, duration, new Vector3(strength, strength, strength), vibrato, randomness, ignoreZAxis, false, fadeOut);
        }
        /// <summary>Shakes a Vector3 with the given values.</summary>
        /// <param name="getter">A getter for the field or property to tween.
        /// <para>Example usage with lambda:</para><code>()=> myProperty</code></param>
        ...
        {
            return Shake<TCore>(getter, setter, duration, strength, vibrato, randomness, false, true, fadeOut);
        }

        static TCore Shake<TCore>(DOGetter<Vector3> getter, DOSetter<Vector3> setter, float duration,
        ...
        ) where TCore : TweenerCore<Vector3, Vector3[], Vector3ArrayOptions>, new()
        {
            ...
            return ToArray<TCore>(getter, setter, tos, tDurations)
                .NoFrom<TCore, Vector3, Vector3[], Vector3ArrayOptions>().SetSpecialStartupMode(SpecialStartupMode.SetShake);
        }
        ...
        {
            return ToArray<TweenerCore<Vector3, Vector3[], Vector3ArrayOptions>>(getter, setter, endValues, durations);
        }
        ...
        /// <param name="endValues">The end values to reach for each segment. This array must have the same length as <code>durations</code></param>
        /// <param name="durations">The duration of each segment. This array must have the same length as <code>endValues</code></param>
        public static TCore ToArray<TCore>(DOGetter<Vector3> getter, DOSetter<Vector3> setter, Vector3[] endValues, float[] durations) where TCore : TweenerCore<Vector3, Vector3[], Vector3ArrayOptions>, new()
        {
            ...
            TCore t =
                ApplyTo<TCore, Vector3, Vector3[], Vector3ArrayOptions>(getter, setter, endValuesClone, totDuration)
                    .NoFrom<TCore, Vector3, Vector3[], Vector3ArrayOptions>();
        ...
        internal static TCore To<TCore>(DOGetter<Color2> getter, DOSetter<Color2> setter, Color2 endValue, float duration)
        where TCore : TweenerCore<Color2, Color2, ColorOptions>, new()
        { return ApplyTo<TCore, Color2, Color2, ColorOptions>(getter, setter, endValue, duration); }
        ...
        /// <param name="playingOnly">If TRUE returns only the tweens with the given ID that are currently playing</param>
        /// <param name="fillableList">If NULL creates a new list, otherwise clears and fills this one (and thus saves allocations)</param>
        public static List<Tween> TweensById(int id, bool playingOnly = false, List<Tween> fillableList = null)
        {
            fillableList?.Clear();
            return TweenManager.GetTweensById(id, playingOnly, fillableList);
        }
        ...
        /// <param name="playingOnly">If TRUE returns only the tweens with the given ID that are currently playing</param>
        /// <param name="fillableList">If NULL creates a new list, otherwise clears and fills this one (and thus saves allocations)</param>
        public static List<Tween> TweensById(long id, bool playingOnly = false, List<Tween> fillableList = null)
        {
            fillableList?.Clear();
            return TweenManager.GetTweensById(id, playingOnly, fillableList);
        }
        ...
        internal static TweenerCore<T1, T2, TPlugOptions> ApplyTo<T1, T2, TPlugOptions>(
            DOGetter<T1> getter, DOSetter<T1> setter, T2 endValue, float duration, ABSTweenPlugin<T1, T2, TPlugOptions> plugin = null
        )
            where TPlugOptions : struct, IPlugOptions
        {
            return ApplyTo<TweenerCore<T1, T2, TPlugOptions>, T1, T2, TPlugOptions>(getter, setter, endValue, duration, plugin);
        }
        
        internal static TCore ApplyTo<TCore, T1, T2, TPlugOptions>(
            DOGetter<T1> getter, DOSetter<T1> setter, T2 endValue, float duration, ABSTweenPlugin<T1, T2, TPlugOptions> plugin = null
        )
            where TCore : TweenerCore<T1, T2, TPlugOptions>, new() where TPlugOptions : struct, IPlugOptions
        {
            AssertUnityThread();
            InitCheck();
            TCore tweener = TweenManager.GetTweener<TCore, T1, T2, TPlugOptions>();
