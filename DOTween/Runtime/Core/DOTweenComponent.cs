...
namespace DG.Tweening.Core
{
    ...
    {
        public static TweenCallback onBeforeUpdate;
        public static TweenCallback onAfterUpdate;
        public static TweenCallback onBeforeLateUpdate;
        public static TweenCallback onAfterLateUpdate;
        public static TweenCallback onBeforeFixedUpdate;
        public static TweenCallback onAfterFixedUpdate;
        ...
        void Update()
        {
            ...
            if (TweenManager.hasActiveDefaultTweens) {
                TweenManager.Update(UpdateType.Normal, UnityEngine.Time.deltaTime);
            }
            _unscaledTime = Time.realtimeSinceStartup;
        ...
        void LateUpdate()
        {
            if (TweenManager.hasActiveLateTweens) {
                ...
                TweenManager.Update(UpdateType.Late, UnityEngine.Time.deltaTime);
        ...
        void FixedUpdate()
        {
            if (TweenManager.hasActiveFixedTweens && Time.timeScale > 0) {
                ...
                TweenManager.Update(UpdateType.Fixed, UnityEngine.Time.deltaTime);
