...
namespace DG.Tweening.Core
{
    ...
    public static class Extensions
    {
        ...
        /// INTERNAL: used by DO shortcuts and Modules to set the tween as blendable
        /// </summary>
        public static TCore Blendable<TCore, T1, T2, TPlugOptions>(this TCore t) where TCore : TweenerCore<T1, T2, TPlugOptions>, new()
            where TPlugOptions : struct, IPlugOptions
        {
            t.isBlendable = true;
            return t;
        ...
        /// INTERNAL: used by DO shortcuts and Modules to prevent a tween from using a From setup even if passed
        /// </summary>
        public static TCore NoFrom<TCore, T1, T2, TPlugOptions>(this TCore t) where TCore : TweenerCore<T1, T2, TPlugOptions>, new()
            where TPlugOptions : struct, IPlugOptions
        {
            t.isFromAllowed = false;
            return t;
