...
namespace DG.Tweening
{
    ...
    public static class TweenSettingsExtensions
    {
        ...
        /// <summary>Sets an long ID for the tween (<see cref="Tween.longId"/>), which can then be used as a filter with DOTween's static methods.<para/>
        /// Filtering via long is 4X faster than via object, 2X faster than via string (using the alternate object/string overloads)</summary>
        /// <param name="longId">The long ID to assign to this tween.</param>
        public static T SetId<T>(this T t, long longId) where T : Tween
        {
            if (t == null || !t.active) return t;
...
//            if (t.tweenType == TweenType.Tweener) t.fullDuration = loops > -1 ? t.duration * loops : Mathf.Infinity;
        ...
        [System.Obsolete(DOTween.STREAMING_OBSOLETE_REASON)]
        ...
        ///<inheritdoc cref="OnStart{T}"/>
        public static T OnStart<T,TObj>(this T t, TObj passedObject, TweenCallback<TObj> action) where T : Tween where TObj : Object 
        {
            return t.OnStart(PassedObjCallback(passedObject, action));
        }
        ...
        ///<inheritdoc cref="OnPlay{T}"/>
        public static T OnPlay<T,TObj>(this T t, TObj passedObject, TweenCallback<TObj> action) where T : Tween where TObj : Object 
        {
            return t.OnPlay(PassedObjCallback(passedObject, action));
        }
        ...
        ///<inheritdoc cref="OnPause{T}"/>
        public static T OnPause<T,TObj>(this T t, TObj passedObject, TweenCallback<TObj> action) where T : Tween where TObj : Object 
        {
            return t.OnPause(PassedObjCallback(passedObject, action));
        }
        ...
        ///<inheritdoc cref="OnRewind{T}"/>
        public static T OnRewind<T,TObj>(this T t, TObj passedObject, TweenCallback<TObj> action) where T : Tween where TObj : Object 
        {
            return t.OnRewind(PassedObjCallback(passedObject, action));
        }
        ...
        ///<inheritdoc cref="OnUpdate{T}"/>
        public static T OnUpdate<T,TObj>(this T t, TObj passedObject, TweenCallback<TObj> action) where T : Tween where TObj : Object 
        {
            return t.OnUpdate(PassedObjCallback(passedObject, action));
        }
        ...
        ///<inheritdoc cref="OnStepComplete{T}"/>
        public static T OnStepComplete<T,TObj>(this T t, TObj passedObject, TweenCallback<TObj> action) where T : Tween where TObj : Object 
        {
            return t.OnStepComplete(PassedObjCallback(passedObject, action));
        }
        ...
        ///<inheritdoc cref="OnComplete{T}"/>
        public static T OnComplete<T,TObj>(this T t, TObj passedObject, TweenCallback<TObj> action) where T : Tween where TObj : Object 
        {
            return t.OnComplete(PassedObjCallback(passedObject, action));
        }
        ...
        ///<inheritdoc cref="OnKill{T}"/>
        public static T OnKill<T,TObj>(this T t, TObj passedObject, TweenCallback<TObj> action) where T : Tween where TObj : Object 
        {
            return t.OnKill(PassedObjCallback(passedObject, action));
        }
...
//            t.target = asTween.target;
            ...
            t.animationCurve = asTween.animationCurve;
        ...
        public static T SetAs<T>(this T t, TweenParams tweenParams) where T : Tween
        {
            ...
            TweenManager.SetUpdateType(t, tweenParams.updateType);
            t.timeScale = tweenParams.timeScale;
            t.isBackwards = tweenParams.isBackwards;
            t.id = tweenParams.id;
...
//                t.easeType = t.tweenType == TweenType.Sequence ? Ease.Linear : DOTween.defaultEaseType; // Doesn't work w webplayer (why?)
            ...
            t.animationCurve = tweenParams.animationCurve;
        ...
        ///<inheritdoc cref="AppendCallback(DG.Tweening.Sequence,DG.Tweening.TweenCallback)"/>
        public static Sequence AppendCallback<TObj>(this Sequence s, TObj passedObj, TweenCallback<TObj> callback) where TObj : Object
        {
            return s.AppendCallback(PassedObjCallback(passedObj, callback));
        }
        ...
        ///<inheritdoc cref="PrependCallback(DG.Tweening.Sequence,DG.Tweening.TweenCallback)"/>
        public static Sequence PrependCallback<TObj>(this Sequence s, TObj passedObj, TweenCallback<TObj> callback) where TObj : Object
        {
            return s.PrependCallback(PassedObjCallback(passedObj, callback));
        }
        ...
        ///<inheritdoc cref="InsertCallback(DG.Tweening.Sequence,float,DG.Tweening.TweenCallback)"/>
        public static Sequence InsertCallback<TObj>(this Sequence s, float atPosition, TObj passedObj, TweenCallback<TObj> callback) where TObj : Object
        {
            return s.InsertCallback(atPosition, PassedObjCallback(passedObj, callback));
        }
        
        static TweenCallback PassedObjCallback<TObj>(TObj obj, TweenCallback<TObj> callback) where TObj : Object {
            return () => { if(obj) callback(obj); };
        }
        #endregion
        ...
        internal static TweenerCore<T1, T2, TOptions> SetStreamingData<T1, T2, TOptions>(this TweenerCore<T1, T2, TOptions> t, TweenStreamingData streamingData) where TOptions : struct, IPlugOptions
        {
            if (t != null && t.active) 
            {
                t.streamingData = streamingData;
            }
            return t;
        }
